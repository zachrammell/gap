...
template <Enum E>
constexpr E operator~(E e) { return E(~rep(e)); }
...
template <Enum E>
constexpr bool any_of(E a, E b) { return !!rep(a & b); }

template <Enum E>
constexpr E remove_flag(E e, E f) { return e & ~f; }

template <Enum E>
constexpr E toggle(E e, E f) { return E(rep(e) ^ rep(f)); }
